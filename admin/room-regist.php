...
if(isset($_POST['update'])) {
    ...
    $number = mysqli_real_escape_string($con, $_POST['roomnumber']);
    $capacity = mysqli_real_escape_string($con, $_POST['capacity']);
    $roomtype = mysqli_real_escape_string($con, $_POST['roomtype']);
    $des = mysqli_real_escape_string($con, $_POST['price']);


    // Attempt insert query execution
    $query = "INSERT INTO room (RoomNumber, Capacity, RoomPrice, RoomType,Status)
              VALUES ('$number', '$capacity', '$des', '$roomtype',1)";
...
<h1>Өрөө бүртгэх</h1>
  ...
  <tr>
    ...
    <td><input type="text" name="roomnumber" id="name" class="form-control"></td>
  </tr>
  <tr>
    <td height="42">Багтаамж</td>
    <td><input type="text" name="capacity" id=""  class="form-control"></td>
  </tr>
    <td height="42">Төрөл</td>
    <td><input type="text" name="roomtype" class="form-control">
    </td>
    <tr>
    <td height="42">Үнэ</td>
