...
if(isset($_POST['delete_id'])) {
    ...
    // Delete query
    $delete_query = "DELETE FROM room WHERE RoomID = $delete_id";
...
<div class="page-container row">
                            ...
                            <div class="col-md-12">
                                <div class="grid simple ">
                                    <div class="grid-title no-border">
                                        	<h4>Бүх өрөөны дэлгэрэнгүй мэдээлэл</h4>
                                        <div class="tools">	<a href="javascript:;" class="collapse"></a>
											<a href="room-regist.php"  class="config"></a>
                                    ...
                                    <div class="grid-body no-border">
                                            <table class="table table-hover no-more-tables" id="dataTable" >
                                                ...
                                                <tbody>
                                                <?php $ret=mysqli_query($con,"select * from room");
												$cnt=1;
												while($row=mysqli_fetch_array($ret))
												{
													$_SESSION['ids']=$row['RoomID'];
												?>
                                                    <tr>
    ...
    <form name="abc" action="" method="post">
        <a href="edit-room.php?id=<?php echo $row['RoomID'];?>" class="btn btn-primary btn-xs btn-mini">Засах</a>
        <input type="hidden" name="delete_id" value="<?php echo $row['RoomID']; ?>">
...
<script>
        document.getElementById('exportButton').addEventListener('click', function () {
            ...
            downloadLink.download = 'uruuniitailan.xls';
            downloadLink.click();
        });
    </script>
